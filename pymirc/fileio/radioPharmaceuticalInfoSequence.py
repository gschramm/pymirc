...
def radioPharmaceuticalInfoSequence(
    nuclidecode=None,
    pharmacode=None,
    StartDateTime=None,
    ...
    if HalfLife == None:
        if nuclidecode == "C-111A1":
            HalfLife = 6586.2  # 18-F
        elif nuclidecode == "C-105A1":
            HalfLife = 1223.4  # 11-C
        elif nuclidecode == "C-107A1":
            HalfLife = 597.9  # 13-N
        elif nuclidecode == "C-B1038":
            HalfLife = 122.24  # 15-O
        elif nuclidecode == "C-131A3":
            HalfLife = 4057.74  # 68-Ga
    if HalfLife != None:
        ds.RadionuclideHalfLife = HalfLife

    if PositronFraction == None:
        if nuclidecode == "C-111A1":
            PositronFraction = 0.967  # 18-F
        elif nuclidecode == "C-105A1":
            PositronFraction = 0.998  # 11-C
        elif nuclidecode == "C-107A1":
            PositronFraction = 0.998  # 13-N
        elif nuclidecode == "C-B1038":
            PositronFraction = 0.999  # 15-O
        elif nuclidecode == "C-131A3":
            PositronFraction = 0.889  # 68-Ga
    if PositronFraction != None:
        ds.RadionuclidePositronFraction = PositronFraction

    if TotalDose != None:
        ds.RadionuclideTotalDose = TotalDose
    if StartDateTime != None:
        ds.RadiopharmaceuticalStartDateTime = StartDateTime
