...
def binary_2d_image_to_contours(img, include_holes = True):
  """Conversion of a 2d binary image (segmentation) into a set of contours
  ...
  include_holes: bool, optional
    whether to computer contours of holes insides objects and to include
    them as well (default True)
