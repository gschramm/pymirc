...
def downsample_3d_0(array, zoom, cval=0):
    ...
    for j in prange(n1):
        for i in range(ns):
            for k in range(n2):
                ib_l = (1.0 / delta) * (i - 0.5 * ns) + 0.5 * nb
                ib_r = (1.0 / delta) * (i + 1 - 0.5 * ns) + 0.5 * nb
...
def downsample_3d_1(array, zoom, cval=0):
    ...
    for i in prange(n0):
        for j in range(ns):
            for k in range(n2):
                ib_l = (1.0 / delta) * (j - 0.5 * ns) + 0.5 * nb
                ib_r = (1.0 / delta) * (j + 1 - 0.5 * ns) + 0.5 * nb
...
def downsample_3d_2(array, zoom, cval=0):
    ...
    for i in prange(n0):
        for j in range(n1):
            for k in range(ns):
                ib_l = (1.0 / delta) * (k - 0.5 * ns) + 0.5 * nb
                ib_r = (1.0 / delta) * (k + 1 - 0.5 * ns) + 0.5 * nb
