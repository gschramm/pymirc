...
if not pymirc_path in sys.path:
    sys.path.append(pymirc_path)
...
parser.add_argument(
    "--dcm_tag_file",
    help="txt file with dcm tags to copy",
    default="dcm_tags_to_copy.txt",
)
parser.add_argument(
    "--series_desc_prefix",
    help="prefix for dcm series description",
    default="(KUL Segmentation)",
)
parser.add_argument("--output_modality", help="dicom modality of output", default="CT")
...
ref_dcm = pydicom.dcmread(args.ref_dcm_file)
